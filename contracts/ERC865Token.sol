 ...
 *
 */
contract ERC865Token is ERC865, PausableToken, MintableToken {

    /* Nonces of transfers performed */
    //mapping(bytes => bool) signatures;
    ERC865Database internal interfaceData;
    ...
    constructor 
    (
        address _interfaceData
    ) 
        public
    {
        interfaceData = ERC865Database(_interfaceData);
    }
        ...
        returns (bool)
    {
        ...
        require(interfaceData.getSignatures(_signature) == false);
        ...
        interfaceData.setSignatures(_signature, true);
